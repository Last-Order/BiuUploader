...
AV.Asset = (function(_super) {
  ...
  Asset.prototype.biu = function(callback){
      this.once('metadata',(function(_this){
          return function(value){
              return _this.biuRecevier('metadata', value, callback);
          }
      })(this));
      this.once('format',(function(_this){
          return function(value){
              return _this.biuRecevier('format', value, callback);
          }
      })(this));
      return this.start();
  }
  Asset.prototype.biuRecevier = function(key, value, callback){
      if (!this.biuData){
          this.biuData = {};
          this.biuData[key] = value;
      }
      else{
          this.biuData[key] = value;
      }
      if (this.biuData['metadata'] && this.biuData['format']){
          this.stop();
          callback(this.biuData);
      }
  }
